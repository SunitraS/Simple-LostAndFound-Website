<?php
function getReceivedItems($searchTerm = null)
{
    require('conn.php');

    $sql = "SELECT ID, Name, Description, Image FROM LostItems WHERE Status = 'Received'";
...
$receivedItems = getReceivedItems($searchTerm);
?>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
                ...
                <li class="nav-item dropdown"> <!-- Updated class to include 'dropdown' -->
                    ...
                    if ($result->num_rows > 0) {
                        ...
                        while ($row = $result->fetch_assoc()) {
                            // ให้เพิ่ม parameter ในฟังก์ชัน changeCategory
                ...
                <li class="nav-item active">
                    <a class="nav-link" href="received.php">Received <span class="sr-only">(current)</span></a>
                </li>
                <li>
                    <form class="form-inline my-2 my-lg-0 ml-auto" method="GET" action="received.php">
